...
public final class PreviewerSpi implements SpellAnimationGroups {
	...
	@Override public List<NameSupplierPair<SpellAnimationGroup>> get() {
		return Arrays.asList(
			...
			, new NameSupplierPair<>("Wind/Excalibur", () -> new Excalibur())
			...
			, new NameSupplierPair<>("Light/Atom", () -> new Atom())
			, new NameSupplierPair<>("Light/LightBurst/Gradient", () -> new LightBurst())
			, new NameSupplierPair<>("Light/LightBurst/Pixel", () -> new LightBurstPixel())

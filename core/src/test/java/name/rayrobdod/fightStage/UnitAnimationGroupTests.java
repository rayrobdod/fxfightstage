...
public final class UnitAnimationGroupTests {
	...
	public static void getObjectBehindLayer_isStable(Supplier<UnitAnimationGroup> s) {
	...
	public static void getObjectBehindLayer_notStatic(Supplier<UnitAnimationGroup> s) {
	...
	public static void getObjectFrontLayer_isStable(Supplier<UnitAnimationGroup> s) {
		UnitAnimationGroup v = s.get();
	...
	public static void getObjectFrontLayer_notStatic(Supplier<UnitAnimationGroup> s) {
		UnitAnimationGroup v1 = s.get();
	...
	public static Stream<DynamicTest> allTests(String prefix, Supplier<UnitAnimationGroup> dut) {
		return Stream.of(
			  dynamicTest(prefix + "_getObjectBehindLayer_isStable", () -> getObjectBehindLayer_isStable(dut))
			, dynamicTest(prefix + "_getObjectBehindLayer_notStatic", () -> getObjectBehindLayer_notStatic(dut))
			, dynamicTest(prefix + "_getObjectFrontLayer_isStable", () -> getObjectFrontLayer_isStable(dut))
			, dynamicTest(prefix + "_getObjectFrontLayer_notStatic", () -> getObjectFrontLayer_notStatic(dut))
